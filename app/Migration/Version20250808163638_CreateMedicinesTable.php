...
final class Version20250808163638_CreateMedicinesTable extends AbstractMigration
{
    ...
    {
        return 'Create "' . MedicineDoctrineRepository::tableName() . '" table';
    }

    public function up(Schema $schema): void
    {
        $diseaseTable = $schema->createTable(MedicineDoctrineRepository::tableName());
        ...
        $diseaseTable->addPrimaryKeyConstraint(
            new PrimaryKeyConstraint(null, [UnqualifiedName::quoted(MedicineId::primitiveName())], true),
        );
    }

    public function down(Schema $schema): void
    {
        $schema->dropTable(MedicineDoctrineRepository::tableName());
    }
}
