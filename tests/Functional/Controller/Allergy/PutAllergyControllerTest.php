...
class PutAllergyControllerTest extends FunctionalTestCase
{
    ...
    public function testPutAllergyUpdateNameOkResponse(): void
    {
        ...
        $this->insert(AllergyDoctrineRepository::tableName(), $allergyData);
        ...
        $storedAllergy = $this->findById(AllergyDoctrineRepository::tableName(), new AllergyId($allergyData[AllergyId::primitiveName()]));
    ...
    protected function setUp(): void
    {
        ...
        $this->deleteAll(AllergyDoctrineRepository::tableName());
    }
}
