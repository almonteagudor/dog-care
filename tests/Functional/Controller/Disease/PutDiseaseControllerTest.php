...
class PutDiseaseControllerTest extends FunctionalTestCase
{
    ...
    public function testPutDiseaseUpdateNameOkResponse(): void
    {
        ...
        $this->insert(DiseaseDoctrineRepository::tableName(), $diseaseData);
        ...
        $storedDisease = $this->findById(DiseaseDoctrineRepository::tableName(), new DiseaseId($diseaseData[DiseaseId::primitiveName()]));
